...
set form [rp_getform]
ns_set delkey $form date
set previous_month_url [export_vars -base [ad_return_url] { {date $prev_month} }]
set next_month_url [export_vars -base [ad_return_url] { {date $next_month} }]
